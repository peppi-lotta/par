...
```{r}
# Specify the file path
file_path <- "./data_prior_1111.csv"

# Read the data
data <- read.csv(file_path)

# Add the interval and prior columns
data$interval <- 0.95  # Set the interval value
data$prior <- "1,1,1,1"  # Set the prior value as a string

# Save the updated data back to a CSV file
write.csv(data, "data_prior_1111_updated.csv", row.names = FALSE)
